...
union_model = load_model("python_script/saved_models/union.h5")
boi_model = load_model("python_script/saved_models/boi.h5")
bob_model = load_model("python_script/saved_models/BankOfBaroda.h5")
sbi_model = load_model("python_script/saved_models/sbi.h5")
pnb_model = load_model("python_script/saved_models/pnb.h5")
